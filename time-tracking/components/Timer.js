...
import { millisecondsToHuam } from '../utils/TimerUtils';
...
export default class Timer extends Component {
    static propTypes = {
        ...
        onStopPresss: PropTypes.func.isRequired,
    };
    ...
    handleStopPress = () => {
        const { id, onStopPresss } = this.props;
    ...
    render() {
        ...
        const elapsedString = millisecondsToHuam(elapsed);
